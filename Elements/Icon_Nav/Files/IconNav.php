...
namespace SA_EL_ADDONS\Elements\Icon_Nav\Files;

if (!defined('ABSPATH')) {
    exit;
}

class IconNav  extends \Walker_Nav_Menu
{
    var $has_child = false;
    public function start_lvl(&$output, $depth = 0, $args = array())
    {
        $output .= '<ul class="sa-el-nav-sub">';
    }
