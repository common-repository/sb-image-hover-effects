var SaElSmoothScrollHandler = function($scope, $) {

    $(document).ready(function($) {
        var $container = $('.sa-el-smooth-scroll', $scope);
        if ($container.length) {
...
jQuery(window).on("elementor/frontend/init", function() {
    elementorFrontend.hooks.addAction(
        "frontend/element_ready/sa_el_smooth_scroll.default",
        SaElSmoothScrollHandler
    );
});