...
namespace SA_EL_ADDONS\Elements\Buddypress_Member;
...
class Buddypress_Member extends Widget_Base {
    ...
    public function get_name() {
        return 'sa_el_buddypress_member';
    }

    public function get_title() {
        return esc_html__('Buddypress Member', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
                'members_type',
                [
                    'label' => esc_html__('Members Type', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_responsive_control(
                'max_members',
                [
                    'label' => esc_html__('Max Members', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sa-el-buddypress-members .sa-el-grid' => 'margin-left: -{{SIZE}}px',
                        '{{WRAPPER}} .sa-el-buddypress-members .sa-el-grid > *' => 'padding-left: {{SIZE}}px',
                    ],
                ]
        );
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sa-el-buddypress-members .sa-el-grid' => 'margin-top: -{{SIZE}}px',
                        '{{WRAPPER}} .sa-el-buddypress-members .sa-el-grid > *' => 'margin-top: {{SIZE}}px',
                    ],
                ]
        );
        ...
        $this->add_group_control(
                ...
                [
                    ...
                    'placeholder' => '1px',
                    'default' => '1px',
                    'selector' => '{{WRAPPER}} .sa-el-bp-member-avatar img',
                    'separator' => 'before',
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    ...
                    'size_units' => ['px', '%'],
                    'selectors' => [
                        '{{WRAPPER}} .sa-el-bp-member-avatar img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; overflow: hidden;',
                    ],
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sa-el-bp-member-avatar img' => 'opacity: {{SIZE}};',
                    ],
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sa-el-bp-member-avatar img' => 'margin-bottom: {{SIZE}}{{UNIT}}',
                    ],
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sa-el-bp-member-title a' => 'color: {{VALUE}};',
                    ],
                ]
        );
        ...
        $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .sa-el-bp-member-title a',
    ...
    public function render() {
        if (is_plugin_active('buddypress/bp-loader.php')) :
            ...
            if (bp_has_members($members_args)) :
                ...
                <div class="sa-el-buddypress-members">
                ...
                <?php while (bp_members()) : bp_the_member(); ?>
                    ...
                    <?php
                    $this->add_render_attribute('bp-member', 'class', 'sa-el-bp-member sa-el-custom-tooltip');

                    if ('auto' !== $settings['columns']) {
                        $this->add_render_attribute('bp-member', 'class', 'sa-el-width-1-' . $settings['columns_mobile']);
                        $this->add_render_attribute('bp-member', 'class', 'sa-el-width-1-' . $settings['columns_tablet'] . '@s');
                        $this->add_render_attribute('bp-member', 'class', 'sa-el-width-1-' . $settings['columns'] . '@m');
                    } else {
                        $this->add_render_attribute('bp-member', 'class', 'sa-el-width-auto');
                    }

                    if ($settings['show_meta_as_tooltip']) :
                        ?>
                                <?php if ('active' === $type) : ?>
                                    <?php $this->add_render_attribute('bp-member', 'data-custom-tooltip', bp_get_member_last_active(), true); ?>
                                <?php elseif ('newest' === $type) : ?>
                                    <?php $this->add_render_attribute('bp-member', 'data-custom-tooltip', bp_get_member_registered(), true); ?>
                                <?php elseif (bp_is_active('friends') and ( 'popular' === $type)) : ?>
                                    <?php $this->add_render_attribute('bp-member', 'data-custom-tooltip', bp_get_member_total_friend_count(), true); ?>
                                <?php endif; ?>
                            <?php endif; ?>

                            <div <?php echo $this->get_render_attribute_string('bp-member'); ?>>
                            <?php if ($settings['show_avatar']) : ?>
                                    <div class="sa-el-bp-member-avatar">
                                        <a href="<?php bp_member_permalink(); ?>"><?php bp_member_avatar($avatar); ?></a>
                                    </div>
                                <?php endif; ?>

                    <?php if ($settings['show_title']) : ?>
                                    <div class="sa-el-bp-member-title fn"><a href="<?php bp_member_permalink(); ?>"><?php bp_member_name(); ?></a></div>
                                <?php endif; ?>
                            </div>
                    ...
                    <?php else : ?>
                <div class="sa-el-alert-warning" >There were no members found, please try another filter.</div>
            <?php
            endif;
        else :
